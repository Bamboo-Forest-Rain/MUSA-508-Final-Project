...
DAT_map <-
  DAT_map %>%
  mutate(quantile = case_when(average.day > 0 & average.day < 20 ~ "1 - 19",
                              average.day >= 20 & average.day < 40 ~ "20 - 39",
                              average.day >= 40 & average.day < 60 ~ "40 - 59",
                              average.day >= 60 & average.day < 80 ~ "60 - 79",
                              average.day >= 80 & average.day < 100 ~ "80 - 99",
                              average.day >= 100 ~ "99 +"))
